...
class KGAT(object):
    ...
    def _get_kg_inference(self, h, r, pos_t, neg_t):
        ...
        embeddings = self.weights['entity_embed']
    ...
    def _create_bi_interaction_embed(self):
        ...
        ego_embeddings = self.weights['entity_embed']
        ...
        ua_embeddings, ea_embeddings = tf.split(all_embeddings, [self.n_users, self.n_entities - self.n_users], 0)
    ...
    def _create_graphsage_embed(self):
        ...
        pre_embeddings = self.weights['entity_embed']
